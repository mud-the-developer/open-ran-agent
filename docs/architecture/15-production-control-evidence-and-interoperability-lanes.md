...
| Broader interoperability profiles | Future lane | current contracts stay fixed to the declared `n79` plus real `Open5GS` scope; topology-scale claim profiles for multi-cell, multi-DU, multi-UE, and mobility are reviewable under `YON-66`, but they are not runtime-proven parity claims |
...
| --- | --- | --- | --- | --- | --- |
| `Repo-local OAI RFsim rehearsal lane` | `oai_split_rfsim_repo_local_v1` | `examples/ranctl/verify-oai-du-docker.json`, `apps/ran_action_gateway/test/ran_action_gateway/cli_test.exs`, `examples/oai/simulation/*.json` | `examples/ranctl/rollback-oai-du-docker.json`, `artifacts/captures/chg-oai-du-001.json` | `docs/architecture/09-oai-du-runtime-bridge.md`, `docs/architecture/14-debug-and-evidence-workflow.md`, `docs/architecture/16-oai-rfsim-ue-sim-dashboard-walkthrough.md` | no live-lab claim, no real core claim, no RU timing claim, no broader profile parity claim |
| `Declared live protocol lane` | `n79_single_ru_single_ue_lab_v1` | `subprojects/ran_replacement/examples/status/verify-attach-ping-open5gs-n79.status.json`, `apps/ran_action_gateway/test/ran_action_gateway/replacement_examples_test.exs` | `subprojects/ran_replacement/examples/status/rollback-gnb-cutover-open5gs-n79.status.json`, `subprojects/ran_replacement/examples/artifacts/n79-single-ru-single-ue-open5gs-family-v1/rollback-evidence-failed-cutover-open5gs-n79.json` | `docs/architecture/03-failure-domains.md`, `docs/architecture/14-debug-and-evidence-workflow.md` | no multi-cell, multi-DU, multi-UE, mobility, or broad RU/core/profile parity claim |
...
- Treat the repo-local OAI RFsim rehearsal lane as simulation-only proof, and
...
- Treat vendor-backed `Aerial`, external-worker `cuMAC`, and broader profile
  ...
  family bundle.
- Do not promote the current single-`n79` lane into multi-cell, multi-DU,
  multi-UE, mobility, or broad profile parity claims.
