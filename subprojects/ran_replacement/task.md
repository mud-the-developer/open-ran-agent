...
3. Add package-local contract notes and example fixtures for `f1e1_control_edge`, `user_plane_edge`, and `core_link_edge` before any implementation code lands there.
