# n79 Single-RU Open5GS Family Evidence Bundle

This directory is the family-specific evidence bundle for the current
`n79_single_ru_single_ue_lab_v1` replacement lane.
...
Use this bundle only for the declared family. New RU/core/profile families must
add sibling bundles instead of widening this one.
